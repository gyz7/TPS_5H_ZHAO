...
public class MultithreadedTcpServer {
	...
	PrenotazionePosti prenota;

	public static void main(String[] args) throws Exception {
	   
		int count = 0; // conta il numero di client
		int prenotazionenum=5;
		PrenotazionePosti prenota = new PrenotazionePosti (prenotazionenum);
		...
		while(count<MAX_CONN) {
			...
			TcpServer sa = new TcpServer(serverClientSocket, count, prenota);
			sa.start();
